    ...
    \begin{proof}
        ...
        \begin{description}
            ...
            \begin{description}
                ...
                \begin{align*}
                    (\m{N}, x) \models (\exists v_n) \varphi & \stackrel{\m{M} \preceq \m{N}}{\Leftrightarrow} (\m{M}, x) \models (\exists v_n) \varphi \\
            ...
            \end{description}
            \item[``$ \Leftarrow $''] z. Z. ist $ \forall \varphi \forall x \in M^\mathbb{N}: (\m{M}, x) \models \varphi \Leftrightarrow (\m{N}, x) \models \varphi $.
        \end{description}
    \end{proof}
